...
// AssertEnergyInvoiceGasUsageChargesRequired checks if the required fields are not zero-ed
func AssertEnergyInvoiceGasUsageChargesRequired(obj EnergyInvoiceGasUsageCharges) error {
...
// AssertEnergyInvoiceGasUsageChargesConstraints checks if the values respects the defined constraints
func AssertEnergyInvoiceGasUsageChargesConstraints(obj EnergyInvoiceGasUsageCharges) error {
	return nil
}
