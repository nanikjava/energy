...
// AssertEnergyPlanContractFullV3Required checks if the required fields are not zero-ed
func AssertEnergyPlanContractFullV3Required(obj EnergyPlanContractFullV3) error {
...
// AssertEnergyPlanContractFullV3Constraints checks if the values respects the defined constraints
func AssertEnergyPlanContractFullV3Constraints(obj EnergyPlanContractFullV3) error {
	return nil
}
